...
public class Controller {
            ...
            for (String dataLine : dataLines){// read in each line of the file
                ...
                if (tokens.length >= 4) {
                    ...
                    if (city1==null || city2 == null){
                        ...
                        Edge e = new Edge(edgeId, city1, city2,capacity,0);
    ...
    public void reportaugmentationPaths(ArrayList<Pair<ArrayList<String>, Integer>> aPaths){
        if(aPaths!=null){
            ...
            lineText.setText("No Augmentation Paths found between "+startLocation.getName() + "[" + startLocation.getId() + "] and " + goalLocation.getName() + "[" + goalLocation.getId() + "]"); 
        }
    }
}
